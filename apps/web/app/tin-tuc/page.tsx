...
const articles = [
  { id: 1, title: 'iPhone 16 Pro lộ diện với thiết kế hoàn toàn mới', image: 'https://cdn.cellphones.com.vn/358x358,webp/media/catalog/product/i/p/iphone-15-pro-max_3.png', category: 'iPhone', date: '16/08/2024', author: 'Nguyễn Văn A', views: 1234, comments: 45, excerpt: 'Theo nguồn tin từ Apple, iPhone 16 Pro s� có thiết kế hoàn toàn mới với viền màn hình siêu mỏng...' },
  { id: 2, title: 'Samsung Galaxy S25 Ultra sẽ có camera 200MP?', image: 'https://cdn.cellphones.com.vn/358x358,webp/media/catalog/product/s/a/samsung-galaxy-s24-ultra_2.png', category: 'Samsung', date: '15/08/2024', author: 'Trần Thị B', views: 892, comments: 32, excerpt: 'Samsung đang phát triển cảm biến camera 200MP thế hệ mới cho Galaxy S25 Ultra...' },
  { id: 3, title: 'MacBook Air M4 ra mắt cuối năm nay', image: 'https://cdn.cellphones.com.vn/358x358,webp/media/catalog/product/m/a/macbook-air-m2_2.png', category: 'Laptop', date: '14/08/2024', author: 'Lê Văn C', views: 567, comments: 23, excerpt: 'Theo Bloomberg, Apple sẽ ra mắt MacBook Air M4 vào tháng 10 năm nay với hiệu năng vượt trội...' },
  { id: 4, title: 'Xiaomi 14 Ultra - Đối thủ đáng gờm của iPhone 15 Pro Max', image: 'https://cdn.cellphones.com.vn/358x358,webp/media/catalog/product/x/i/xiaomi-14-ultra.png', category: 'Xiaomi', date: '13/08/2024', author: 'Phạm Thị D', views: 1456, comments: 67, excerpt: 'Xiaomi 14 Ultra với camera Leica đang tạo nên cuộc cạnh tranh khốc liệt với iPhone 15 Pro Max...' },
  { id: 5, title: 'Top 10 laptop gaming đáng mua nhất 2024', image: 'https://cdn.cellphones.com.vn/358x358,webp/media/catalog/product/a/s/asus-rog-strix-g16.png', category: 'Laptop', date: '12/08/2024', author: 'Hoàng Văn E', views: 2345, comments: 89, excerpt: 'Danh sách những chiếc laptop gaming có cấu hình mạnh mẽ và giá cả hợp lý nhất...' },
  { id: 6, title: 'Hướng dẫn chọn mua iPhone phù hợp nhất', image: 'https://cdn.cellphones.com.vn/358x358,webp/media/catalog/product/i/p/iphone-15_2.png', category: 'iPhone', date: '11/08/2024', author: 'Vũ Thị F', views: 1789, comments: 56, excerpt: 'Bài viết chi tiết giúp bạn chọn được chiếc iPhone phù hợp với nhu cầu và ngân sách...' },
]
